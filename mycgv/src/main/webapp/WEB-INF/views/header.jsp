		...
		<div class="header_contents1">
			...
			<div>
				...
				<a href="http://localhost:9000/mycgv/login.do" target="_parent">
					<img
					src="http://localhost:9000/mycgv/resources/images/loginPassword.png">
					<span>로그인</span>
				</a> <a href="http://localhost:9000/mycgv/join.do" target="_parent">
					<img
					src="http://localhost:9000/mycgv/resources/images/loginJoin.png">
					<span>회원가입</span>
				</a> <a href="http://localhost:9000/mycgv/mycgv.do" target="_parent">
					<img
					src="http://localhost:9000/mycgv/resources/images/loginMember.png">
					<span>MY CGV</span>
				</a> <a href="http://localhost:9000/mycgv/board_list.do"
					target="_parent"> <img
					src="http://localhost:9000/mycgv/resources/images/loginCustomer.png">
					<span>게시판</span>
				</a> <a href="http://localhost:9000/mycgv/notice_list.do"
					target="_parent"> <img
					src="http://localhost:9000/mycgv/resources/images/loginCustomer.png">
					<span>공지사항</span>
				</a> 
			...
			<div>
				...
				<a href="http://localhost:9000/mycgv/notice_list.do" target="_parent" >
					...
					<% if(sid.equals("admin")){ //session의 "sid"의 값이 admin이면 보이도록 설정%>
					<a href="http://localhost:9000/mycgv/admin.do" target="_parent" >
						<img src="http://localhost:9000/mycgv/resources/images/loginCustomer.png">
						<span>Admin</span>
					</a>				
